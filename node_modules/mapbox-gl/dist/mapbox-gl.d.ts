...
type WorkerSourceLoadTileData = (params: WorkerSourceTileRequest, callback: Callback<unknown>) => Cancelable["cancel"];
...
declare class Tile {
	...
	updateBuckets(painter: Painter, isBrightnessChanged?: boolean, states?: LayerFeatureStates): void;
	holdingForFade(): boolean;
